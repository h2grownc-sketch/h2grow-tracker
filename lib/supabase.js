...
// True when env vars are present and a client exists. The UI uses this to
// show a "database not connected" banner instead of a false empty state.
...
export async function fetchJobs() {
  ...
  try {
    ...
    // Rethrow so the UI can distinguish "can't reach database" from
    // "no jobs yet" — swallowing this made outages look like data loss.
